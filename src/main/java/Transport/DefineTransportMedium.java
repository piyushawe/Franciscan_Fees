...
public class DefineTransportMedium {
	...
	@FindBy(id="ContentPlaceHolder1_txtTransportMediumName_TextBox")WebElement transportmedium;
	...
	public void enterTransportMedium(String  tmedium)
	{
		transportmedium.sendKeys(tmedium);
	}
