...
public class DefineLastResult {
	WebDriver dr;
	Utility u= new Utility();
	String pg= "DefineLastResult";

	@FindBy(id="ContentPlaceHolder1_txtLastResult_TextBox")WebElement lastresult;
	...
	public void openDefineLastResult()
	{
	   WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Global-Masters.png']"));
	   Actions builder= new Actions(dr);
	   builder.moveToElement(menu).build().perform();
	   dr.findElement(By.linkText("Define Last Result")).click();
	   dr.switchTo().frame(dr.findElement(By.id("Define Last Result")));
	...
	public void enterLastResult(String lresult)
	{
		lastresult.sendKeys(lresult);
	}
