...
public class DefineExtraActivity {
	...
	@FindBy(id="ContentPlaceHolder1_txtActivity_TextBox")WebElement activity;
	...
	public void enterExtraActivity(String eact)
	{
		activity.sendKeys(eact);
	}
	...
	public void clickView(String school, Collection<String> sc)throws IOException
	{
		...
		if (cells.size()>1) {
			for (WebElement cell : cells) {
				cell.findElement(By.xpath("//input[starts-with(@id,'ContentPlaceHolder1_rptActivity')]")).click();
				break;
			}
