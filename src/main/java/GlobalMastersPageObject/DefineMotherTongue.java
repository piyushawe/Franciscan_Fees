...
public class DefineMotherTongue {
	WebDriver dr;
	Utility u= new Utility();
	String pg= "DefineMotherTongue";

	@FindBy(id="ContentPlaceHolder1_txtmothertongue_TextBox")WebElement mothertongue;
	...
	public void openDefineMotherTongue()
	{
	   WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Global-Masters.png']"));
	   Actions builder= new Actions(dr);
	   builder.moveToElement(menu).build().perform();
	   dr.findElement(By.linkText("Define Mother Tongue")).click();
	   dr.switchTo().frame(dr.findElement(By.id("Define Mother Tongue")));
	 ...
	 public void enterMotherTongue(String lang)
	 {
