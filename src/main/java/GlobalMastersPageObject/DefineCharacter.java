...
public class DefineCharacter {
	...
	String pg= "DefineCharacter";

	@FindBy(id="ContentPlaceHolder1_txtCharacter_TextBox")WebElement character;
	...
	public void openDefineCharacter()
	{
	   WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Global-Masters.png']"));
	   Actions builder= new Actions(dr);
	   builder.moveToElement(menu).build().perform();
	   dr.findElement(By.linkText("Define Character")).click();
	   dr.switchTo().frame(dr.findElement(By.id("Define Character")));
	...
	public void enterCharacter(String ch)
	{
		character.sendKeys(ch);
	}
	...
	public void clickView(String school, Collection<String> sc)throws IOException
	{
		...
		if (cells.size()>1) {
			for (WebElement cell : cells) {
				cell.findElement(By.xpath("//input[starts-with(@id,'ContentPlaceHolder1_rptCharacter')]")).click();
				break;
			}
