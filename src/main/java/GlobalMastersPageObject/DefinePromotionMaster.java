...
public class DefinePromotionMaster {
	...
	@FindBy(id="ContentPlaceHolder1_txtPramotion_TextBox")WebElement promotion;
	...
	public void enterPromotion(String pro)
	{
		promotion.sendKeys(pro);
	}
	...
	public void clickView(String school, Collection<String> sc)throws IOException
	{
		...
		if (cells.size()>1) {
			for (WebElement cell : cells) {
				cell.findElement(By.xpath("//input[starts-with(@id,'ContentPlaceHolder1_rptPramotion')]")).click();
				break;
			}
