...
public class DefineTcCaste {
	...
	public DefineTcCaste(WebDriver d)
	{
	   this.dr=d;
	   PageFactory.initElements(d, this);
    }
	public void openDefineTcCaste()
	{
	   WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Global-Masters.png']"));
	   Actions builder= new Actions(dr);
	   builder.moveToElement(menu).build().perform();
	   dr.findElement(By.linkText("Define TC Caste")).click();
	   dr.switchTo().frame(dr.findElement(By.id("Define TC Caste")));
	...
	public void enterCaste(String ct)
	{
		caste.sendKeys(ct);
	}
	...
	public void clickView(String school, Collection<String> sc)throws IOException
	{
		...
		if (cells.size()>1) {
			for (WebElement cell : cells) {
				cell.findElement(By.xpath("//input[starts-with(@id,'ContentPlaceHolder1_rptTCaste')]")).click();
				break;
			}
