...
public class DefineReligion {
	WebDriver dr;
	Utility u= new Utility();
	String pg= "DefineReligion";

	@FindBy(id="ContentPlaceHolder1_txtReligion_TextBox")WebElement religion;
	...
	public void openDefineReligion()
	{
	   WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Global-Masters.png']"));
	   Actions builder= new Actions(dr);
	   builder.moveToElement(menu).build().perform();
	   dr.findElement(By.linkText("Define Religion")).click();
	   dr.switchTo().frame(dr.findElement(By.id("Define Religion")));
	 ...
	 public void enterReligion(String lang)
	 {
		religion.sendKeys(lang);
	 }
	 ...
	 public void clickView(String school, Collection<String> sc)throws IOException
	 {
		 ...
		 if (cells.size()>1) {
			for (WebElement cell : cells) {
				cell.findElement(By.xpath("//input[starts-with(@id,'ContentPlaceHolder1_rptReligion')]")).click();
				break;
			}
