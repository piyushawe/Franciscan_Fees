...
public class DefineSection {
	...
	String pg= "DefineSection";

	@FindBy(id="ContentPlaceHolder1_txtSectionName_TextBox")WebElement section;
	@FindBy(id="ContentPlaceHolder1_txtOrderId_TextBox")WebElement orderno;
	...
	public void openDefineSection()
	{
	   WebElement menu= dr.findElement(By.xpath("//img[@src='/Images/layout/Global-Masters.png']"));
	   Actions builder= new Actions(dr);
	   builder.moveToElement(menu).build().perform();
	   dr.findElement(By.linkText("Define Section")).click();
	   dr.switchTo().frame(dr.findElement(By.id("Define Section")));
	...
	public void enterSection(String sec)
	{
		section.sendKeys(sec);
	}
	public void enterOrderNo(String ordno)
	{
		orderno.sendKeys(ordno);
	}
	...
	public void clickView(String school, Collection<String> sc)throws IOException
	{
		...
		if (cells.size()>1) {
			for (WebElement cell : cells) {
				cell.findElement(By.xpath("//input[starts-with(@id,'ContentPlaceHolder1_rptsecionDefine')]")).click();
				break;
			}
